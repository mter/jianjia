...
local function InitRes(this,bgpic)
    ...
    if ScreenText.selection==nil then
        ...
        ScreenText.selection:SetSize(1,1):SetSprite('Resources/Images/hand.png'):SetAlign(flux.ALIGN_LEFT):SetHUD(true)
        this:AddView(ScreenText.selection)
    end

    --初始化立绘
    ScreenText.portrait = flux.View(this)
    ScreenText.portrait:SetSize(8.8,20.34):SetHUD(true)--:SetAlpha(1)
